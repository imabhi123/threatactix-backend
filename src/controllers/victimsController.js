...
import Incident from "../models/victimSchema.js";
      ...
      transformedData.map(async (rowData, index) => {
        if (index === 0) {
          ...
          const admin = await Admin.findOneAndUpdate(
            { _id: userId, victimHeadings: { $exists: true, $size: 0 } },
            { victimHeadings: headingsArray },
            { new: true }
          );
          console.log(admin,'lskd')
        }
        // console.log(rowData)
